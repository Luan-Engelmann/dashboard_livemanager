// O código visual e a lógica da API foram extraídos do App.jsx antigo para cá. A única diferença é a substituição do estado isLoggedIn pelo hook useNavigate para direcionar a rota correta após o sucesso.
...
function Login() {
  ...
  // Verifica se o usuário já tem token e tenta acessar o /login. Redireciona direto.
  useEffect(() => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate('/dashboard'); // Redirecionamento via rota
      } else {
